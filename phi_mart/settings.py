...
INSTALLED_APPS = [
    ...
    'rest_framework', 
    'djoser', # Django REST Framework for API development
    'api',
    'users',
    'product',
    'order',
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR/'media'  # Directory to store uploaded media
...
REST_FRAMEWORK = {
    'COERCE_DECIMAL_TO_STRING': False,  # Avoid coercing decimal fields to strings
